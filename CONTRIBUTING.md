...
- Create an [issue](https://github.com/nolimits4web/dom7/issues) on GitHub, if you have found a bug
...
- Submit an [issue](https://github.com/nolimits4web/dom7/issues), assuming one does not already exist.
